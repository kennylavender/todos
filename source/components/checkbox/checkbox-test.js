...
test("Checkbox", t => {
  ...
  t.test("render an unchecked box", t => {
    ...
    t.deepEqual($("input").attr('checked'), undefined, "should not render checked when isChecked is false");
  ...
  t.test("render an checked box", t => {
    ...
    t.deepEqual($("input").attr('checked'), 'checked', "should render checked when isChecked is true");
